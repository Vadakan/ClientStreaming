...
import (
	...
	books "github.com/ClientStreaming/stub/pb/books"
...
func (c container) initBooks() []*books.ValidationReq {
	...
	c.books = append(c.books, c.getBook("3", "Bo", "Movies and TV shows", "Carl Matz", "2.9", 225, 2015))
	c.books = append(c.books, c.getBook("4", "Bo", "Cookies", "Carl Matz", "2.2", 275, 2011))
	c.books = append(c.books, c.getBook("5", "Book 5", "Learn more about animals and nature", "John Phill", "2.7", 455, 2018))
	c.books = append(c.books, c.getBook("6", "Book 6 with long title", "Machine learning", "John Phill", "1.0", 375, 2016))
	c.books = append(c.books, c.getBook("7", "Book", "10 good ideas for decorating your house", "Maty Metzer", "3.2", 250, 2007))
	return c.books
}
